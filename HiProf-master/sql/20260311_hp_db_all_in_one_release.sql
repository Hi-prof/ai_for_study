...
-- ===================================================================
-- BEGIN FILE: 20260326_hp_db_missing_course_tables_fix.sql
-- ===================================================================
-- 缺失课程相关业务表修复脚本
-- 生成时间：2026-03-26
...
-- 3. chat_session 当前后端模型已补 course_id，但历史旧数据若没有课程归属，需要后续人工回填。
...
-- END FILE: 20260326_hp_db_missing_course_tables_fix.sql
